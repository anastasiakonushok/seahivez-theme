...
$header = ! empty( $args['header'] ) && is_array( $args['header'] ) ? $args['header'] : seahivez_get_home_gallery_header();
$items  = ! empty( $args['items'] ) && is_array( $args['items'] ) ? $args['items'] : seahivez_get_home_gallery_items();
