	...
	array(
		...
		'fields'                => array(
			...
			array(
				...
				'sub_fields' => array(
					array(
						'key'   => 'field_shvz_social_instagram_url',
						'label' => 'Instagram URL',
						'name'  => 'instagram_url',
						'type'  => 'url',
					),
					...
					array(
						'key'   => 'field_shvz_social_whatsapp_url',
						'label' => 'WhatsApp URL (optional override)',
						'name'  => 'whatsapp_url',
						'type'  => 'url',
					),
					array(
						'key'   => 'field_shvz_social_telegram_url',
						'label' => 'Telegram URL',
						'name'  => 'telegram_url',
						'type'  => 'url',
					),
		...
		'layout_shvz_specs_bar' => array(
			...
			'sub_fields' => array(
				array(
					...
					'sub_fields'   => array(
						seahivez_get_acf_icon_field_schema( 'field_shvz_specs_icon' ),
						array( 'key' => 'field_shvz_specs_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text' ),
						array( 'key' => 'field_shvz_specs_value', 'label' => 'Value', 'name' => 'value', 'type' => 'text' ),
					),
				),
			),
		),
				...
				array(
					...
					'sub_fields'   => array(
						...
						array(
							...
							'sub_fields'   => array(
								seahivez_get_acf_icon_field_schema( 'field_shvz_specs_group_icon' ),
								array( 'key' => 'field_shvz_specs_group_label', 'label' => 'Label', 'name' => 'label', 'type' => 'text' ),
								array( 'key' => 'field_shvz_specs_group_value', 'label' => 'Value', 'name' => 'value', 'type' => 'text' ),
							),
						),
					),
				),
		...
		'layout_shvz_experiences' => array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'sub_fields'   => array(
						array( 'key' => 'field_shvz_exp_title', 'label' => 'Title', 'name' => 'title', 'type' => 'text' ),
						array( 'key' => 'field_shvz_exp_duration', 'label' => 'Duration', 'name' => 'duration', 'type' => 'text' ),
						array( 'key' => 'field_shvz_exp_time_slot', 'label' => 'Time slot', 'name' => 'time_slot', 'type' => 'text' ),
						array( 'key' => 'field_shvz_exp_price', 'label' => 'Price', 'name' => 'price', 'type' => 'text' ),
						array( 'key' => 'field_shvz_exp_description', 'label' => 'Description', 'name' => 'description', 'type' => 'textarea', 'rows' => 3 ),
						array( 'key' => 'field_shvz_exp_image', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'array' ),
						array( 'key' => 'field_shvz_exp_link', 'label' => 'Link', 'name' => 'link', 'type' => 'link' ),
					),
				),
			),
		),
